export default function ShortBanner() {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-black px-3.5 py-1 sm:px-1.5 sm:before:flex-1 border-b border-indigo-400">
      <div
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-white">
          <span className="text-yellow-100">
            Limited Period Offer: Get up to 8% off + extra 15% off on medicines
            & more offers.
          </span>
        </p>
        <a
