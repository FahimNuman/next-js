        ...
        <ul className="flex flex-wrap items-center text-sm">
          ...
          {serviceTypes.map(serviceType => (
            ...
            >
              ...
              >
                 {/* here i render ------------------------- Render serviceType */}
              ...
              <button
                ...
                aria-expanded={hoveredServiceType === serviceType.ServiceTypeID ? 'true' : 'false'}
                onClick={() =>
                  setHoveredServiceType(hovered => (hovered === serviceType.ServiceTypeID ? null : serviceType.ServiceTypeID))
                }
              >
             ...
             >
                   ...
                   {/* here i render ------------------------- Render categories */}
                  {categories.map(category => (
                    <li key={category.CategoryID}>
                      ...
                      {/* here i render ------------------------- Render subcategories */}
