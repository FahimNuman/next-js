        ...
        <div className='mx-4 md:mx-16 pb-4 px-2'>
          ...
          <div className='flex flex-col md:flex-row'>
            <div className='w-full md:w-1/3 flex justify-center items-start mt-8'>
              <PictureGallery key={index.SkuID} image={index.SkuImage} />
            </div>
            <div className='w-fit md:w-1/3 flex flex-col p-8 gap-4'>
              <div className='flex flex-col gap-4'>
                <h1 className='font-semibold text-2xl'>{index.SkuName}</h1>
                <p className='text-sm text-[#ff766b]'>{index.Remark}</p>
                <p className='text-sm text-[#ff766b]'>{index.SkuBrandName}</p>
              </div>
              <div className=''>
        ...
        <div className='bg-[#f8f8f8] flex flex-col md:flex-row'>
          ...
          <div className='md:flex flex-col md:w-1/3 m-8 md:gap-4 lg:visible lg:flex gap-4'>
            <div className='bg-white hidden lg:visible'>
              ...
              <img className="w-32 h-32 mx-auto rounded-full border-12 border-red-500" src={`http://localhost:5047/${index.SkuImage}`} alt="Logo" />
